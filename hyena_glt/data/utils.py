                        ...
                        if codon in ['TAA', 'TAG', 'TGA']:
                            ...
                            if orf_length >= min_length:
                                orfs.append({
                                    ...
                                    'protein': translate_dna(seq[start_pos:end_pos+3])
                                })
                            break
...
def validate_sequence(sequence: str, sequence_type: str = "dna") -> Tuple[bool, List[str]]:
...
def sequence_stats(sequence: str, sequence_type: str = "dna") -> Dict:
...
def mask_sequence(sequence: str, mask_probability: float = 0.15, mask_token: str = "[MASK]") -> Tuple[str, List[int]]:
