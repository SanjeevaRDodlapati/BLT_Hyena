...
class GenomicDataLoader:
    ...
    def __init__(
        ...
        padding: bool = True,
        preprocessing: Optional[GenomicPreprocessor] = None,
    ...
    def _load_dataset_from_file(self, file_path: Union[str, Path]) -> Dataset:
    ...
    def _load_fasta_dataset(self, file_path: Path) -> Dataset:
        ...
        try:
            ...
            raise ImportError("BioPython required for FASTA file loading")
    ...
    def _load_fastq_dataset(self, file_path: Path) -> Dataset:
        ...
        try:
            ...
            raise ImportError("BioPython required for FASTQ file loading")
...
class StreamingDataLoader:
    ...
    def __init__(
        self,
        data_source: Union[str, Path, Iterator],
        tokenizer: GenomicTokenizer,
        batch_size: int = 32,
        max_length: Optional[int] = None,
    ...
    def _fasta_iterator(self, file_path: Path) -> Iterator[Dict[str, Any]]:
        ...
        try:
            ...
            raise ImportError("BioPython required for FASTA streaming")
...
def create_genomic_dataloaders(
    train_data: Union[Dataset, str, Path],
    val_data: Optional[Union[Dataset, str, Path]] = None,
    test_data: Optional[Union[Dataset, str, Path]] = None,
