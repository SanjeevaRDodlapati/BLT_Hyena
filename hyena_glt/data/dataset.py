...
class TokenClassificationDataset(GenomicDataset):
    ...
    def _create_label_mappings(self, all_labels: List[str]) -> Tuple[Dict[str, int], Dict[int, str]]:
    ...
    def _align_labels_with_tokens(
        ...
        label_idx = 0
        for i in range(1, sequence_length - 1):  # Skip CLS and SEP
...
class MultiTaskDataset(Dataset):
    ...
    def __init__(
        ...
        self.task_weights = task_weights or {task: 1.0 for task in datasets.keys()}
