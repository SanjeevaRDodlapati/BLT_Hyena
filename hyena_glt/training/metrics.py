...
class GenomicMetrics:
            ...
            for label in unique_labels:
                ...
                if label_mask.sum() > 0:
                    label_acc = accuracy_score(
                        targets[label_mask], pred_classes[label_mask]
                    )
        ...
        try:
            ...
            for i in range(0, len(self.sequences), 2):
                if i + 1 < len(self.sequences):
                    ...
                    score = sentence_bleu(
                        reference, candidate, smoothing_function=smoothing
                    )
    ...
    def _compute_sequence_similarity(
        ...
        try:
            edit_distances = []
            for pred_seq, target_seq in zip(predictions, targets, strict=False):
    ...
    def get_detailed_report(self) -> str:
        ...
        other_metrics = {
            ...
            and k not in precision_recall_metrics
