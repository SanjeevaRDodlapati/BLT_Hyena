...
from hyena_glt.cli.main import main, create_parser
...
class TestTrainCommand:
    ...
    def test_train_command_with_overrides(self):
        ...
        with patch('hyena_glt.cli.train.HyenaGLTTrainer') as mock_trainer_class, \
...
class TestEvaluateCommand:
    ...
    def test_evaluate_command_execution(self, mock_dataset, mock_model, mock_evaluator_class):
    ...
    def test_evaluate_command_with_output_file(self):
        ...
        with patch('hyena_glt.cli.evaluate.HyenaGLTEvaluator') as mock_evaluator_class, \
...
class TestGenerateCommand:
    ...
    def test_generate_command_multiple_samples(self):
        ...
        with patch('hyena_glt.cli.generate.HyenaGLT.from_pretrained') as mock_model, \
