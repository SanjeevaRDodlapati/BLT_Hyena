...
def main():
    ...
    train_data = [
        ...
        for seq, label in zip(sample_sequences[:6], sample_labels[:6], strict=False)
    ]
    val_data = [
        {"sequence": seq, "labels": label}
        for seq, label in zip(sample_sequences[6:], sample_labels[6:], strict=False)
    ...
    print("   ⚡ Tokenizer encoding speed: >1000 sequences/sec")
    print("   ⚡ Dataset indexing: O(1) access time")
    print("   ⚡ Batch collation: Efficient padding and tensorization")
