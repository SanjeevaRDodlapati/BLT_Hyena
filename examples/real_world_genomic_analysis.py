...
from hyena_glt.evaluation import GenomicEvaluator
from hyena_glt.utils import SequenceUtils, PlottingUtils
...
class GenomicAnalysisDemo:
    ...
    def _plot_regulatory_analysis(self, analysis):
        ...
        for a in analysis:
            type_counts = {i: 0 for i in range(5)}
...
def main():
    ...
    # Run selected demo(s)
    if args.demo == 'all':
        results = demo.run_full_demo_suite()
    elif args.demo == '1':
        results = demo.demo_1_variant_effect_prediction()
    elif args.demo == '2':
        results = demo.demo_2_gene_expression_prediction()
    elif args.demo == '3':
        results = demo.demo_3_regulatory_element_detection()
    elif args.demo == '4':
        results = demo.demo_4_comparative_genomics()
