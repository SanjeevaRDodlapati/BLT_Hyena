...
try:
    ...
    HAS_SKLEARN = False
    warnings.warn("Scikit-learn not available. Some functionality will be limited.", stacklevel=2)
...
def quick_train_model(
    ...
    try:
        ...
        raise ImportError(f"Required Hyena-GLT modules not available: {e}") from e
